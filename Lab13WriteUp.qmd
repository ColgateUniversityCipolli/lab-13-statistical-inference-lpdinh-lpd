...
```{r}
#| label: tbl-sumcloser
#| tbl-cap: "Summary for average % change in fluorescence for closer renditions"
#| tbl-align: "center"
#| echo: false

closer_summary |> knitr::kable(digits = 2)
```
...
further_summary |> knitr::kable(digits = 2)
```
...
diff_summary |> knitr::kable(digits = 2)
```
